...
void bookmarkInjection() {
  ...
  getIt.registerLazySingleton<GetBookmarks>(
    () => GetBookmarks(
      repository: getIt(),
    ),
  );
  getIt.registerLazySingleton<AddBookmark>(
    () => AddBookmark(
      repository: getIt(),
    ),
  );
  ...
  getIt.registerLazySingleton<AddBookmarkCategory>(
    () => AddBookmarkCategory(
      repository: getIt(),
    ),
  );
  ...
  getIt.registerLazySingleton<UpdateBookmark>(
    () => UpdateBookmark(
      repository: getIt(),
    ),
  );
