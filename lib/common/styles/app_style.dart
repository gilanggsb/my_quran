  ...
  static AppColorsExtension _createAppColors(bool isLight) {
    return AppColorsExtension(
      colors: {
        ...
        AppColorType.primaryDark1: AppPalette.primary.dark1,
        AppColorType.primaryDark2: AppPalette.primary.dark2,
        AppColorType.primaryDark3: AppPalette.primary.dark3,
        AppColorType.primaryDark4: AppPalette.primary.dark4,
        AppColorType.primaryLight: AppPalette.primary.light,
        AppColorType.primaryLight1: AppPalette.primary.light1,
